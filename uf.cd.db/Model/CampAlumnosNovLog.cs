...
public partial class CampAlumnosNovLog
{
    public string? CanvIdAlumno { get; set; }
    ...
    public string? CanvApellido { get; set; }

    public string? CanvNombre { get; set; }

    public int? CanvIdTipodoc { get; set; }

    public string? CanvNrodoc { get; set; }

    public string? CanvIdSexo { get; set; }
    ...
    public string? CanvExtranjero { get; set; }
